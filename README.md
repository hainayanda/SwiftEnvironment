...
3. Choose **Up to Next Major** for the version rule and set the version to **4.1.7**
...
```swift
dependencies: [
    .package(url: "https://github.com/hainayanda/SwiftEnvironment.git", .upToNextMajor(from: "4.1.7"))
]
```
